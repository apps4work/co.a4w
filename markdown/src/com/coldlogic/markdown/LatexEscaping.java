...
public class LatexEscaping {

    public static final String LATEX_ESCAPABLE = "[\\#\\$\\%\\^\\&\\_\\{\\}\\~\\\\\\[\\]]";
    public static final Pattern LATEX_PATTERN = Pattern.compile(LATEX_ESCAPABLE);
    ...
    private static final Replacer LATEX_REPLACER = new Replacer() {
        @Override
        public void replace(String input, StringBuilder sb) {
            switch (input) {
                case "\\":
...
//    }
    ...
    public static String escapeLatex(String s) {
        s = LatexEscaping.replaceAll(LATEX_PATTERN, s, LATEX_REPLACER);
        s = s.replace("...", "$\\ldots$");
        s =s.replace(" \"", " ``");
        s =s.replace("(\"", "(``");
        s =s.replace(" \'", " `");
    ...
    public static void main(String[] args) {
        String s = LATEX_ESCAPABLE;
        s = "[#$%^&_{}~\\]";
        System.out.println(s);
        System.out.println(escapeLatex(s));
